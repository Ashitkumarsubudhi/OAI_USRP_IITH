...
uint32_t fbs_enable;
uint32_t msg1_drop_enable;
uint32_t msg3_drop_enable;
uint32_t msg1_display_enable;
uint32_t msg3_display_enable;
                             ...
                             int max_cell_info)
{
  ...
  *info->tac = *GNBParamList.paramarray[0][GNB_TRACKING_AREA_CODE_IDX].uptr;
  ...
  //<add:IITH>
/*
  *fbs_enable = *GNBParamList.paramarray[0][GNB_CONFIG_FBS_ENABLE1].uptr;
  //printf("FBS Enable %u\n", fbs_enable);
*/
  // SNSSAI
                                         ...
                                         seq_arr_t *du_SIBs)
{
  ...
  //<add:IITH>
  //req->f1ap_fbs_enable = fbs_enable1;
  //</add:IITH>
    ...
    for (j = 0; j < RC.nb_nr_macrlc_inst; j++) {
      ...
      if (strcmp(*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_N_PREFERENCE_IDX].strptr), "local_RRC") == 0) {
       ...
       // RC.nrmac[j]->eth_params_n.my_portc = *(MacRLC_ParamList.paramarray[j][MACRLC_LOCAL_N_PORTC_IDX].iptr);
        fbs_enable = *(MacRLC_ParamList.paramarray[j][MACRLC_FBS_ENABLE_IDX].iptr);
        msg1_drop_enable  = *(MacRLC_ParamList.paramarray[j][MACRLC_MSG1_DROP_ENABLE_IDX].iptr);
        msg3_drop_enable  =  *(MacRLC_ParamList.paramarray[j][MACRLC_MSG3_DROP_ENABLE_IDX].iptr);
        msg1_display_enable  = *(MacRLC_ParamList.paramarray[j][MACRLC_MSG1_DISPLAY_ENABLE_IDX].iptr);
        msg3_display_enable   =   *(MacRLC_ParamList.paramarray[j][MACRLC_MSG3_DISPLAY_ENABLE_IDX].iptr);
        printf("Abhishek: fbs_enable %u, msg1_drop_enable %u, msg3_drop_enable %u, msg1_display_enable %u,  msg3_display_enable  %u\n",  fbs_enable,  msg1_drop_enable,  msg3_drop_enable,  msg1_display_enable, msg3_display_enable);
        //printf("Abhishek: fbs_enable %u\n",  fbs_enable);
        RC.nrmac[j]->eth_params_n.remote_portc = *(MacRLC_ParamList.paramarray[j][MACRLC_REMOTE1_N_PORTC_IDX].iptr);
        RC.nrmac[j]->eth_params_n.my_portd = *(MacRLC_ParamList.paramarray[j][MACRLC_LOCAL1_N_PORTD_IDX].iptr);
        RC.nrmac[j]->eth_params_n.remote_portd = *(MacRLC_ParamList.paramarray[j][MACRLC_REMOTE1_N_PORTD_IDX].iptr);
        RC.nrmac[j]->eth_params_n.transp_preference = ETH_UDP_MODE;
         printf("Abhishek: CU and data plane ports are %d and %d\n", RC.nrmac[j]->eth_params_n.remote_portd,  RC.nrmac[j]->eth_params_n.my_portd);
      } else { // other midhaul
        AssertFatal(1 == 0, "MACRLC %d: %s unknown northbound midhaul\n", j, *(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_N_PREFERENCE_IDX].strptr));
      }

      //printf("*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr): %s",*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr));
      //printf("*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr): %s\n",*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr));
      //<add:Ashit commented><add:IITH>
/*      if (strcmp(*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr), "local_L1") == 0) {
            printf("Abhishek:Condition matched\n");
      }
        else if (strcmp(*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr), "nfapi") == 0) {
        printf("Abhishek: Control coming to confgire_nr_nfapi_vnf part0\n");
        RC.nrmac[j]->eth_params_s.my_addr = strdup(*(MacRLC_ParamList.paramarray[j][MACRLC_LOCAL_S_ADDRESS_IDX].strptr));
        printf("Abhishek: Control coming to confgire_nr_nfapi_vnf part1\n");
        RC.nrmac[j]->eth_params_s.remote_addr = strdup(*(MacRLC_ParamList.paramarray[j][MACRLC_REMOTE_S_ADDRESS_IDX].strptr));
        printf("Abhishek: Control coming to confgire_nr_nfapi_vnf part2\n");
        ...
        printf("Abhishek: Control coming to confgire_nr_nfapi_vnf part3\n");
        //configure_nr_nfapi_vnf(
          //  RC.nrmac[j]->eth_params_s.my_addr, RC.nrmac[j]->eth_params_s.my_portc, RC.nrmac[j]->eth_params_s.remote_addr, RC.nrmac[j]->eth_params_s.remote_portd, RC.nrmac[j]->eth_params_s.my_portd);
            //   printf("Abhishek: Control comingout of  confgire_nr_nfapi_vnf part\n");
      } else if(strcmp(*(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr), "aerial") == 0){
        printf("Abhishek: Control coming to confgire_aerial part0_\n");
#ifdef ENABLE_AERIAL
        printf("Abhishek: Control coming to confgire_aerial part0\n");
        ...
        printf("Abhishek: Control coming to confgire_aerial part2\n");
#endif
      } else { // other midhaul
        printf("Abhishek: Control coming to confgire_aerial part\n");
        AssertFatal(1 == 0, "MACRLC %d: %s unknown southbound midhaul\n", j, *(MacRLC_ParamList.paramarray[j][MACRLC_TRANSPORT_S_PREFERENCE_IDX].strptr));
      }*/ //</add:Ashit comment> </add:IITH>
      printf("Abhishek: Getting the metrics\n");
      ...
      // PRB Blacklist
      printf("Abhishek: Received the metrics\n");
      uint16_t prbbl[MAX_BWP_SIZE] = {0};
      int num_ulprbbl = get_prb_blacklist(j, prbbl);
      if (num_ulprbbl != -1) {
   ...
   //<add:IITH>
 //  uint32_t fbs_enable;
//   uint32_t msg1_drop_enable = 0;
//   uint32_t msg3_drop_enable = 0;
//   uint32_t msg1_display_enable = 0;
//   uint32_t msg3_display_enable = 0;
   //</add:IITH>


    char *name = NULL;
    f1ap_served_cell_info_t info;
    read_du_cell_info(cfg, NODE_IS_DU(node_type), &gnb_id, &fbs_enable, &gnb_du_id, &name, &info, 1);

    //LOG_I(PHY, "%u fbs enable\n", fbs_enable);

    printf("Abhishek2: Manage to come here\n");
