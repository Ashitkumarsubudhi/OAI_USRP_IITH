...
#define CONFIG_STRING_MACRLC_FBS_ENABLE                    "fbs_enable"
#define CONFIG_STRING_MACRLC_MSG1_DROP_ENABLE              "msg1_drop_enable"
#define CONFIG_STRING_MACRLC_MSG3_DROP_ENABLE              "msg3_drop_enable"
#define CONFIG_STRING_MACRLC_MSG1_DISPLAY_ENABLE           "msg1_display_enable"
#define CONFIG_STRING_MACRLC_MSG3_DISPLAY_ENABLE           "msg3_display_enable"
#define CONFIG_STRING_MACRLC_REMOTE1_N_PORTC                "remote_n_portc"
#define CONFIG_STRING_MACRLC_LOCAL1_N_PORTD                 "local_n_portd"
#define CONFIG_STRING_MACRLC_REMOTE1_N_PORTD                "remote_n_portd"
...
#define MACRLCPARAMS_DESC { \
  ...
  {CONFIG_STRING_MACRLC_FBS_ENABLE,                  NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_MSG1_DROP_ENABLE,            NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_MSG3_DROP_ENABLE,            NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_MSG1_DISPLAY_ENABLE,         NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_MSG3_DISPLAY_ENABLE,         NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_REMOTE1_N_PORTC,              NULL,                     0, .uptr=NULL,   .defintval=50010,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_LOCAL1_N_PORTD,               NULL,                     0, .uptr=NULL,   .defintval=50011,           TYPE_UINT,    0}, \
  {CONFIG_STRING_MACRLC_REMOTE1_N_PORTD,              NULL,                     0, .uptr=NULL,   .defintval=50011,           TYPE_UINT,    0}, \
...
#define MACRLC_FBS_ENABLE_IDX                                  4
#define MACRLC_MSG1_DROP_ENABLE_IDX                            5
#define MACRLC_MSG3_DROP_ENABLE_IDX                            6
#define MACRLC_MSG1_DISPLAY_ENABLE_IDX                         7
#define MACRLC_MSG3_DISPLAY_ENABLE_IDX                         8
#define MACRLC_REMOTE1_N_PORTC_IDX                             9
#define MACRLC_LOCAL1_N_PORTD_IDX                              10
#define MACRLC_REMOTE1_N_PORTD_IDX                             11
#define MACRLC_TRANSPORT_S_PREFERENCE_IDX                      12
#define MACRLC_LOCAL_S_ADDRESS_IDX                             13
#define MACRLC_REMOTE_S_ADDRESS_IDX                            14
